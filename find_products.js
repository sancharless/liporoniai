...
try {
  ...
  let foundInput = null;
  // Search from the beginning to find the step that contains the user input with the products list
  for (let i = 0; i < lines.length; i++) {
    ...
    try {
      ...
      if (parsed.content && parsed.content.includes('AMMOBOX BBS 0,25g')) {
        ...
        // Let's write this content to a file so we can view/parse it
